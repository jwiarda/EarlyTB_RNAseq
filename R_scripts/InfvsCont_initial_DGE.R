...
wk0Up <- subset(wk0DE, logFC > 0)
wk0Down <- subset(wk0DE, logFC < 0)
head(wk0DE)
# Create plot smear:
...
write.table(wk0Up$genes, "/Users/jayne.wiarda/Desktop/TB/Thesis_Project/82_Cattle_RNAseq/geneLists/InfvsCont_0wpi_up.txt", sep = "\t")
write.table(wk0Down$genes, "/Users/jayne.wiarda/Desktop/TB/Thesis_Project/82_Cattle_RNAseq/geneLists/InfvsCont_0wpi_down.txt", sep = "\t")
...
wk4Up <- subset(wk4DE, logFC > 0)
wk4Down <- subset(wk4DE, logFC < 0)
head(wk4DE, n = 10)
# Create plot smear:
wk4DEnames <- rownames(wk4DE)
plotSmear(wk4lrt, de.tags = wk4DEnames, cex = 0.75, ylim = c(-6,6))
abline(h = c(-1, 1), col = "blue") 
write.table(wk4Up$genes, "/Users/jayne.wiarda/Desktop/TB/Thesis_Project/82_Cattle_RNAseq/geneLists/InfvsCont_4wpi_up.txt", sep = "\t")
write.table(wk4Down$genes, "/Users/jayne.wiarda/Desktop/TB/Thesis_Project/82_Cattle_RNAseq/geneLists/InfvsCont_4wpi_down.txt", sep = "\t")
...
wk10Up <- subset(wk10DE, logFC > 0)
wk10Down <- subset(wk10DE, logFC < 0)
head(wk10DE, n = 10)
# Create plot smear:
wk10DEnames <- rownames(wk10DE)
plotSmear(wk10lrt, de.tags = wk10DEnames, cex = 0.75, ylim = c(-6,6))
abline(h = c(-1, 1), col = "blue") 
write.table(wk10Up$genes, "/Users/jayne.wiarda/Desktop/TB/Thesis_Project/82_Cattle_RNAseq/geneLists/InfvsCont_10wpi_up.txt", sep = "\t")
write.table(wk10Down$genes, "/Users/jayne.wiarda/Desktop/TB/Thesis_Project/82_Cattle_RNAseq/geneLists/InfvsCont_10wpi_down.txt", sep = "\t")
